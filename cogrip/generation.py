...
from cogrip.pentomino.symbolic.types import Colors, Shapes, SymbolicPiece, RelPositions, Rotations
...
def create_color_holdout(shapes: List[Shapes], colors: List[Colors], positions: List[RelPositions],
    ...
    if orientations:
        print("Shape orientations will be applied")
    configs_by_split = {
        "train": set(),
        "test": set()
    }
